...
Assignment: 3
Due Date: 3/27/25
The professor agve me a 3 day extension due to the fact that I was working alone.
...
Demo:
    For the demo, the general process will be testing user management functionality, the communication system,
    game setup and play, game management, persistence, and cleanup.
